...
- **Retention**: Account data is retained while your account is active. You may delete your account in the App at any time (see Section 6). Account identifiers, profile data, preferences, confirmations, reports submitted by that account, and original fuel-price observations submitted by that account are deleted. Report-owned moderation records are deleted with the report; non-identifying records arising from reports submitted by other users may remain for data integrity, abuse prevention, dispute handling, and legal or security obligations.
